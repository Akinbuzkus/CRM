...
df_ = pd.read_csv("C:flo_data_20k.csv")
df = df_.copy()
df.head()
df.shape
...
# 4. Omnichannel müşterilerin hem online'dan hemde offline platformlardan alışveriş yaptığını
# ifade etmektedir.
...
# 1.Veri setindeki en son alışverişin yapıldığı tarihten 2 gün
# sonrasını analiz tarihi olarak alınız.
...
# 3. 5 grup içerisinden seçeceğiniz 2 grup için yönetime kısa kısa
...
# In the ‘A’ segment, we select customers who shop frequently and spend more than
